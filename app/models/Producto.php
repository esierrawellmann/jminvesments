...
class Producto extends database {
  ...
  function newProducto($producto){
    ...
    $queryObject = $this->consulta("select p.id_producto,p.nombre,t.nombre  as 'tipo_producto',t.id_tipo_producto,p.precio_compra,p.precio_venta,p.cantidad from producto p inner join tipo_producto t on p.id_tipo_producto = t.id_tipo_producto order by p.id_producto DESC LIMIT 1; ");
    $this->disconnect();
